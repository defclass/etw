 ...
 * @since 1.1
 */
class DwzGridView0 extends CBaseListView
{
	...
	public function init()
	{
		...
		if(!isset($this->htmlOptions['class']))
			$this->htmlOptions['class']='page grid-view';
...
/**/
	public function run()
	{
		...
		$this->renderKeys();
		echo '<div class="pageContent" layoutH="28">';
		$this->renderContent();
...
//		$cs->registerCoreScript('jquery');
		...
		if ($this->pager['class']==null || $this->pager['class']=='CLinkPager')
			$cs->registerCss('fixPage',"li.page, .grid-view .panelBar li{float:none;} .grid-view .pager{padding:2px 5px;} ul.yiiPager .first, ul.yiiPager .last{display:inline;}");
	}
