  ...
  <div class="list_detail service_tracking f_left">
    <table class="round">
      <tbody>
        ...
        <tr>
          <td class="lb ">
            <!--<div align="right"><a href="#top"><img src="/Themes/StyleBarum/<?php echo Yii::app()->baseUrl;?>/images//common/gototop0.gif" alt="go to top" width="36" height="13" border="0" /></a></div>-->
          </td>
          <td class="rb ">
          </td>
        </tr>
