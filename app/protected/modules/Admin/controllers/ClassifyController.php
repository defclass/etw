...
class ClassifyController extends BackController
{
	/**
...
/**
	...
	{
		$dataProvider=new CActiveDataProvider('Classify');
	...
	{
		$model=new Classify('search');
		$model->unsetAttributes();  // 清除默认值
		if(isset($_GET['Classify']))
			$model->attributes=$_GET['Classify'];
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=Classify::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='classify-form')
		{
